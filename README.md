About py-pandoc-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/py-pandoc-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6171&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/py-pandoc-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `py-pandoc` can be installed with `conda`:
...
```
mamba install py-pandoc
```

It is possible to list all of the versions of `py-pandoc` available on your platform with `conda`:
...
```
mamba search py-pandoc --channel conda-forge
```
...
mamba repoquery search py-pandoc --channel conda-forge

# List packages depending on `py-pandoc`:
mamba repoquery whoneeds py-pandoc --channel conda-forge

# List dependencies of `py-pandoc`:
mamba repoquery depends py-pandoc --channel conda-forge
```
